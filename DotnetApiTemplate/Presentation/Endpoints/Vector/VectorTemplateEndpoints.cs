...
public class VectorTemplateEndpoints : ICarterModule
{
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        .WithMetadata(new OpenApiOperation
        {
            ...
            Tags = new List<OpenApiTag> { new OpenApiTag { Name = "Vector" } },
        ...
        app.MapPost(
            pattern: "/vector/templates/filter",
            handler: async (
